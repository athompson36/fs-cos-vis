...
struct RemoteControlSettings: Equatable {
    ...
    var lightingPerformanceStripEnabled: Bool = true
    var backdropPerformanceStripEnabled: Bool = true
...
extension RemoteControlSettings: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        lightingPerformanceStripEnabled = try c.decodeIfPresent(Bool.self, forKey: .lightingPerformanceStripEnabled) ?? true
        backdropPerformanceStripEnabled = try c.decodeIfPresent(Bool.self, forKey: .backdropPerformanceStripEnabled) ?? true
...
enum RemoteControlSettingsStore {
    private static let key = AppIdentity.remoteControlSettingsDefaultsKey

...
struct SceneEditState: Codable, Equatable, Hashable {
    struct LayerControls: Codable, Equatable, Hashable {
        ...
        /// 0 = Julia … 6 = orbit trap (see `FractalPass.metal`).
        ...
        /// Polar spectrum UV warp strength in composite (0…1).
        ...
        init(
            ...
            self.spectrumWarpAmount = spectrumWarpAmount
        ...
        init(from decoder: Decoder) throws {
            ...
            spectrumWarpAmount = try c.decodeIfPresent(Float.self, forKey: .spectrumWarpAmount) ?? 0.35
        ...
        func encode(to encoder: Encoder) throws {
            ...
            try c.encode(spectrumWarpAmount, forKey: .spectrumWarpAmount)

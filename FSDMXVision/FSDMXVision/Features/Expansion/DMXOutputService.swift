...
enum DMXNetworkPacketBuilder {
    ...
    static func makeSACNPacket(universe: Int, frame: [UInt8], sequence: UInt8) -> [UInt8] {
        ...
        let sourceLabel = Array(AppIdentity.displayName.utf8)
        for i in 0 ..< 64 {
    ...
    private static let sacnSenderCID: [UInt8] = {
        ...
        let label = Array(AppIdentity.displayName.utf8)
...
final class DMXInputService {
    ...
    func start() {
        ...
        let queue = DispatchQueue(label: "com.fsdmxvision.dmx.input", qos: .userInitiated)

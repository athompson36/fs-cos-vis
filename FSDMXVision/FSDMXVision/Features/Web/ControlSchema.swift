        ...
        ControlSchema(sections: [
            ...
            Section(
                ...
                fields: [
                    ...
                    Field(id: "spectrumWarpAmount", label: "Spectrum warp (composite)", kind: "float", min: 0, max: 1, commandType: "SetSpectrumWarpAmount"),
                    Field(id: "fractalGeometryIndex", label: "Fractal geometry (0 Julia … 6 orbit trap)", kind: "float", min: 0, max: 6, commandType: "SetFractalGeometryIndex"),
                ]
            ),
            Section(
                id: "scene_edit",

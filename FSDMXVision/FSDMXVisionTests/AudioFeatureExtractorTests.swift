...
final class AudioFeatureExtractorTests: XCTestCase {
    ...
    func testBinnedMagnitudes_sixteenBins_uniformSpectrum() {
        let mags = [Float](repeating: 1, count: 64)
        let b = AudioFeatureExtractor.binnedMagnitudes(magnitudes: mags, binCount: 16)
